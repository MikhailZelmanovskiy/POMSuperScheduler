...
public class DragableBasic extends BaseScreenADV{
    public DragableBasic(AppiumDriver<MobileElement> driver) {
        super(driver);
    }
    @FindBy(xpath = "//*[@resource-id='com.h6ah4i.android.example.advrecyclerview:id/drag_handle']")
    List<MobileElement> list;

    public DragableBasic dragDown(){
    ...
    public DragableBasic dragDownCount(int count){
        MobileElement el = list.get(0);
